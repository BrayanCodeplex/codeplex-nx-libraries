...
export interface CodeplexCampoTextoProps extends Omit<TextFieldProps, 'label' | 'helperText'> {
    ...
    contenedorProps?: any; // container props if needed
}

const CampoTextoPersonalizado = styled(TextField)(({ theme }) => ({
...
export const CodeplexCampoTexto = ({
    etiqueta,
    textoAyuda,
    ...props
}: CodeplexCampoTextoProps) => {
    return (
...
export const CodeplexTextField = CodeplexCampoTexto;
